  ...
  return (
    <TransitionSeries>
      <TransitionSeries.Sequence durationInFrames={ 20 }>
        <Letter fontSize={ 250 } letter="RENT" backgroundColor={ GREEN } />
      ...
      />
      <TransitionSeries.Sequence durationInFrames={ 20 }>
        <Letter fontSize={ 250 } letter="BUY" backgroundColor={ ORANGE } />
      </TransitionSeries.Sequence>
      <TransitionSeries.Transition
      ...
      />
      <TransitionSeries.Sequence durationInFrames={ 20 }>
        <Letter fontSize={ 220 } letter="SELL" backgroundColor={ BLUE } />
      </TransitionSeries.Sequence>
      <TransitionSeries.Transition
